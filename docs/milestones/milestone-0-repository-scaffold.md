...
- License, repository rules, branch protection, required status checks
- Merge/PR/issue workflows, labels, milestones, project board
...
- [ ] `tooling/docker/docker-compose.yml` present
- [ ] `tooling/scripts/seed-*.ts` stubs present
- [ ] LICENSE, `.nvmrc`, `.env.example` present; `.gitignore` patched
